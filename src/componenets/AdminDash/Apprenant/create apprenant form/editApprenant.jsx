...
function EditApprenant({ onClose , apprenantid}) {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await axios.get(`http://localhost:3500/apprenant/${apprenantid}`);
            ...
            formData.filiere =response.data.niveauAcademique.filiere?response.data.niveauAcademique.filiere:''
            formData.annee =response.data.niveauAcademique.annee
            formData.niveau =response.data.niveauAcademique.niveau
        } catch (err) {
...
const handleSubmit = async (e) => {
  ...
  try {
    console.log(formData)
      const response = await axios.patch(`http://localhost:3500/apprenant/${apprenantid}`, formData);
