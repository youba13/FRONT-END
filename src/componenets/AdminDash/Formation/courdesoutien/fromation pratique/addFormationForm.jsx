...
const CourDeSoutienForm = () => {
    ...
    courseDataToSend.append('domain', courseData.domain);
    courseDataToSend.append('specialite', courseData.specialite);
    ...
    courseDataToSend.append('dateDebut', courseData.dateDebut);
        try {
            const response = await axios.post('http://localhost:3500/formation/formationPratique', courseData, {
                headers: {
        ...
        <div className="  overflow-y-auto mx-auto p-4">
            <form onSubmit={handleSubmit} className=" max-h-[550px] overflow-y-auto space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="domain" id="matiere"
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        onChange={handleChange}
                ...
                <div>
                    <label htmlFor="type" className="block text-sm font-medium text-gray-700">Spécialité</label>
                    <input type="text" name="specialite" id="niveau"
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        onChange={handleChange}
                        value={courseData.specialite}
                    />
                </div>
                <div>
