...
function FormationDeLangueTable() {
    const array =["a","b"]
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3500/formation/formationDeLangue`)
            .then(response => {
                if (!response.ok) {
  ...
  <div className="px-6 py-4">
    ...
    <h1 className='text-bold'>Langue :{item.langue}</h1>
...
export default FormationDeLangueTable